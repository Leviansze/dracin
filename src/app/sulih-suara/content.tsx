...
import { useDubindoDramas } from "@/hooks/useDramas";
...
export default function SulihSuaraContent() {
  ...
  const { data: dramas, isLoading, isFetching } = useDubindoDramas(classify, page);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex gap-2 mb-8">
          <button
            ...
            className={`px-6 py-2.5 rounded-full font-medium transition-all ${classify === "terbaru"
          ...
          <button
            ...
            className={`px-6 py-2.5 rounded-full font-medium transition-all ${classify === "terpopuler"
              ? "bg-primary text-primary-foreground"
              : "glass hover:bg-muted/50"
              }`}
          >
